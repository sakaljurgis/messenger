  ...
  return (
    <div className="mx-auto flex h-full w-full max-w-xl flex-col bg-white">
      <header className="flex flex-shrink-0 items-center gap-2 border-b border-gray-200 px-2 py-2">
        ...
        <h1 className="font-semibold text-gray-900">New group</h1>
        <button
          type="button"
      ...
      <div className="flex-shrink-0 space-y-2 border-b border-gray-100 p-3">
        ...
        <input
          ...
          className="w-full rounded-full border border-gray-300 px-4 py-2 text-gray-900 focus:border-[#0084ff] focus:outline-none"
        />
        ...
        <input
          ...
          className="w-full rounded-full bg-gray-100 px-4 py-2 text-gray-900 focus:outline-none"
        />
      </div>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto p-2">
        {users === null ? (
          ...
          <p className="py-10 text-center text-gray-500">No people found</p>
        ) : (
              ...
              return (
                <li key={user.id}>
                  ...
                  >
                    ...
                    <span className="flex-1 font-medium text-gray-900">{user.displayName}</span>
                    <span
                      className={`flex h-6 w-6 items-center justify-center rounded-full border ${
                        checked ? 'border-[#0084ff] bg-[#0084ff] text-white' : 'border-gray-300 text-transparent'
                      }`}
                    >
                      <CheckIcon />
                    </span>
